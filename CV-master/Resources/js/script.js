...
$(document).ready(function () {
    ...
    var display = function (language) {
        ...
        var exp_job_3_position_label = 'exp-job-3-position-label';
        var exp_job_3_position = 'exp-job-3-position';
        ...
        var game_heading = 'game-heading';
        var game_content = 'game-content';
        var favourite_heading = 'favourite-heading';
        ...
        $('#' + exp_job_3_position_label).text(language[exp_job_3_position_label]);
        $('#' + exp_job_3_position).text(language[exp_job_3_position]);
        ...
        $('#' + game_heading).text(language[game_heading]);
        $('#' + game_content).text(language[game_content]);
        $('#' + favourite_heading).text(language[favourite_heading]);
    };
    getLanguage();
